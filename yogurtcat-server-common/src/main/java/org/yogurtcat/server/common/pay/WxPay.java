...
public class WxPay {
     ...
     * 作用：统一下单<br>
     * 场景：公共号支付、扫码支付、APP支付
     * @param reqData 向wxpay post的请求数据 必须包含notify_url、body、out_trade_no、total_fee、spbill_create_ip、trade_type、openid字段
     * @return API返回数据
     * @throws Exception
     */
     ...
     * 其他：需要证书
     * @param reqData 向wxpay post的请求数据 必须包含out_refund_no、out_trade_no、total_fee、refund_fee字段
     * @return API返回数据
     * @throws Exception
     */
    ...
    public Map<String, String> transfers(Map<String, String> reqData) throws Exception {
    	...
    	if (StringUtils.isEmpty(reqData.get(WxPayConstants.CHECK_NAME))) {
